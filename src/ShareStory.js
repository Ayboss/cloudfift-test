            ...
            <form className="story__form">
                ...
                <div className="story__form-group">
                    ...
                    <label className="story__file-box" for="image">
                        <span className="story__file-box--span">{fileobj.name?fileobj.name:"Choose Image"}</span>
                    ...
                    <input onChange={handleFileChange} accept="image/*" placeholder="Choose Image" className="story__file" type="file" id="image"/>
                </div>    
